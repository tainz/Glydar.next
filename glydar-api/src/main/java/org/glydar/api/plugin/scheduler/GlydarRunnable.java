...
public abstract class GlydarRunnable implements Runnable {
    ...
    public synchronized GlydarTask runTaskLater(Plugin plugin, long delay) throws IllegalArgumentException,
            IllegalStateException {
        checkState();
        return setupId(GlydarScheduler.getInstance().runTaskLater(plugin, this, delay));
    }

    public synchronized GlydarTask runTaskTimer(Plugin plugin, long delay, long period)
