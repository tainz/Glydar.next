package org.glydar.api.plugin.configuration.file;
...
import org.glydar.api.plugin.configuration.Configuration;
import org.glydar.api.plugin.configuration.ConfigurationSection;
import org.glydar.api.plugin.configuration.InvalidConfigurationException;
...
public class YamlConfiguration extends FileConfiguration {
    ...
    public static YamlConfiguration loadConfiguration(File file) {
        ...
        try {
            ...
            Glydar.getLogger(YamlConfiguration.class, "Configuration").severe("Cannot load {0}", file);
        }
        catch (InvalidConfigurationException ex) {
            Glydar.getLogger(YamlConfiguration.class, "Configuration").severe(ex, "Cannot load {0}", file);
        }
    ...
    public static YamlConfiguration loadConfiguration(InputStream stream) {
        ...
        try {
            ...
            Glydar.getLogger(YamlConfiguration.class, "Configuration").severe(ex,
