...
/**
 * Class which handles loading of i18n resources for the given target and
 * locale.
 */
public class I18nLoader {
    ...
    private void loadForEachExtension(Map<String, Object> map, Locale locale, String baseName, I18nFormatLoader loader) {
    ...
    private void loadForEachLocation(Map<String, Object> map, Locale locale, I18nFormatLoader loader, String name) {
    ...
    private void actuallyLoad(Map<String, Object> map, I18nFormatLoader loader, Locale locale, URL location) {
